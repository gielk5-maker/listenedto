        ...
        <div className="space-y-2">
          {items.map((item, i) => (
            <div
              ...
              className={`group flex items-center gap-3 bg-stone-900 rounded-2xl p-3 border transition-all ${
                dragIdx === i ? "border-[var(--accent)] opacity-50" : "border-stone-800/40 hover:border-stone-700"
            ...
            >
              ...
              {/* Album */}
              <Link href={albumHref(item)} className="flex items-center gap-3 flex-1 min-w-0">
